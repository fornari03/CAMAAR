...
Dado('que o sigaa contém a turma {string} \(CIC0097)') do |string|
  pending # Write code here that turns the phrase above into concrete actions
end

Dado('esta turma contém o participante {string} \({int})') do |string, int|
# Dado('esta turma contém o participante {string} \({float})') do |string, float|
  pending # Write code here that turns the phrase above into concrete actions
end

Então('a turma {string} \(CIC0097) deve ser cadastrada no sistema') do |string|
  pending # Write code here that turns the phrase above into concrete actions
end

Então('o usuário {string} \({int}) deve ser cadastrado no sistema') do |string, int|
# Então('o usuário {string} \({float}) deve ser cadastrado no sistema') do |string, float|
  pending # Write code here that turns the phrase above into concrete actions
end
