...
Quando('eu adiciono uma pergunta {string} do tipo {string}') do |string, string2|
  pending # Write code here that turns the phrase above into concrete actions
end

Quando('eu adiciono uma pergunta {string} do tipo {string} com opções {string}') do |string, string2, string3|
  pending # Write code here that turns the phrase above into concrete actions
end
