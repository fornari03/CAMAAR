...
Funcionalidade: Distribuição de Formulários de Avaliação
  ...
  Contexto:
    ...
    E que existe um template "Avaliação Semestral"
  ...
  Cenário: Admin distribui formulário para múltiplas turmas
    ...
    E eu seleciono as turmas "Engenharia de Software" e "Banco de Dados"
    E eu clico em "Distribuir Formulário"
    Então eu devo ver a mensagem "Formulário distribuído com sucesso para 2 turmas"
