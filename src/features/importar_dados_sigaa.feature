...
Funcionalidade: Importar novos dados do SIGAA
  ...
  Cenário: Importação inicial de turma e participante na turma com sucesso
    ...
    E que o sigaa contém a turma "TA" da matéria "BANCOS DE DADOS" ("CIC0097")
    E esta turma contém o participante "Fulano de Tal" ("150084006")
    Quando eu solicito a importação clicando em "Importar dados"
    Então a turma "TA" da matéria "BANCOS DE DADOS" ("CIC0097") deve ser cadastrada no sistema
    E o usuário "Fulano de Tal" ("150084006") deve ser cadastrado no sistema
    E o usuário "150084006" deve estar matriculado na turma "TA" da matéria "CIC0097"
  ...
  Cenário: Importação de nova turma e participante já existente na turma com sucesso
    ...
    E que o sigaa contém a turma "TA" da matéria "ESTRUTURA DE DADOS" ("CIC0002")
    E esta turma contém o participante "Ciclano de Tal" ("150084007")
    Quando eu solicito a importação clicando em "Importar dados"
    Então a turma "TA" da matéria "ESTRUTURA DE DADOS" ("CIC0002") deve ser cadastrada no sistema
    E o usuário "150084007" deve estar matriculado na turma "TA" da matéria "CIC0002"
    E eu devo ver a mensagem de sucesso "Dados importados com sucesso!"

  @happy_path
  Cenário: Importação de turma já existente e novo participante na turma com sucesso
    Dado que o sistema possui a turma "TA" da matéria "ALGORITMOS E PROGRAMAÇÃO" ("CIC0001") cadastrada
    E que o sistema não possui o usuário "Beltrano de Tal" ("150084008") cadastrado
    E que o sigaa contém a turma "TA" da matéria "ALGORITMOS E PROGRAMAÇÃO" ("CIC0001")
    ...
    E o usuário "150084008" deve estar matriculado na turma "TA" da matéria "CIC0001"
    E eu devo ver a mensagem de sucesso "Dados importados com sucesso!"
  ...
  Cenário: Importação sem duplicação de um usuário já existente
    ...
    E que o sigaa contém a turma "TA" da matéria "REDES DE COMPUTADORES" ("CIC0003")
    E esta turma contém o participante "Fulano de Tal" ("150084006")
    Quando eu solicito a importação clicando em "Importar dados"
    Então o usuário "Fulano de Tal" ("150084006") não deve ser duplicado no sistema
    E o usuário "150084006" deve estar matriculado na turma "TA" da matéria "CIC0003"
    E eu devo ver a mensagem de sucesso "Dados importados com sucesso!"
